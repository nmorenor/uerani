//
//  CreateVenueListController.swift
//  uerani
//
...
public class CreateVenueListController: UIViewController, UIGestureRecognizerDelegate {
    ...
    public func show(viewController: UIViewController) {
        ...
        let dialogHieght:CGFloat = 115
        self.dialogView = CreateVenueListDialogView(frame: CGRectMake(25, (self.view.frame.size.height/2) - (dialogHieght * 1.85), self.view.frame.size.width - 50, dialogHieght))
